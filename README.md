...
| 浏览器预览 | 20 条候选结果与完整字段说明 | [查看输出预览](examples/showcase/demo_output_preview.md) |
...
**[查看 19 字段浏览器版输出](examples/showcase/demo_output_preview.md) · [下载完整 Excel 工作簿](examples/showcase/careerreach_agent_output_public.xlsx)**
