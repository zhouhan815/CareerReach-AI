...
def test_build_args_search_with_job_type_uses_click_flag_name():
	args = _build_args("boss_search", {"query": "AI产品经理", "job_type": "实习"})
	assert args == ["search", "AI产品经理", "--job-type", "实习"]
